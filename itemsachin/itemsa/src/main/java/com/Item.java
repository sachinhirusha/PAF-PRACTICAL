...
public class Item {
	...
	private Connection connect()
	{
	 ...
	 con= DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/test","root","Root@123");
	 //For testing
...
output += "<td><input name='btnUpdate' type='button' value='Update' "+ "class='btnUpdate btn btn-secondary' data-itemid='" + itemID + "'></td>"
	 ...
	 + "<td><input name='btnRemove' type='button' value='Remove'class='btnRemove btn btn-danger' data-itemid='" + itemID + "'>" +"</td>";
	 }
	 con.close();
